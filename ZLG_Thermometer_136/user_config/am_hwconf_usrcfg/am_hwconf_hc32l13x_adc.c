...
am_hc32_adc_ioinfo_t __g_adc_ioinfo_list[] = {
    {AMHW_HC32_CHAN_AIN0_PA0 ,  PIOA_0 , PIOA_0_GPIO  | PIOA_0_AIN , PIOA_0_GPIO  | PIOA_0_AIN },
    {AMHW_HC32_CHAN_AIN1_PA1 ,  PIOA_1 , PIOA_1_GPIO  | PIOA_1_AIN , PIOA_1_GPIO  | PIOA_1_AIN },
    {AMHW_HC32_CHAN_AIN2_PA2 ,  PIOA_2 , PIOA_2_GPIO  | PIOA_2_AIN , PIOA_2_GPIO  | PIOA_2_AIN },
    {AMHW_HC32_CHAN_AIN3_PA3 ,  PIOA_3 , PIOA_3_GPIO  | PIOA_3_AIN , PIOA_3_GPIO  | PIOA_3_AIN },
    {AMHW_HC32_CHAN_AIN4_PA4 ,  PIOA_4 , PIOA_4_GPIO  | PIOA_4_AIN , PIOA_4_GPIO  | PIOA_4_AIN },
    {AMHW_HC32_CHAN_AIN5_PA5 ,  PIOA_5 , PIOA_5_GPIO  | PIOA_5_AIN , PIOA_5_GPIO  | PIOA_5_AIN },
    {AMHW_HC32_CHAN_AIN6_PA6 ,  PIOA_6 , PIOA_6_GPIO  | PIOA_6_AIN , PIOA_6_GPIO  | PIOA_6_AIN },
    {AMHW_HC32_CHAN_AIN7_PA7 ,  PIOA_7 , PIOA_7_GPIO  | PIOA_7_AIN , PIOA_7_GPIO  | PIOA_7_AIN },
...
static const am_hc32_adc_devinfo_t __g_adc_devinfo = {
    ...
    AMHW_HC32_ADC_REFVOL_OUTSIDE_PB1,          /**< \brief 参考电压选择 */
    1822,                                 /**< \brief 参考电压(mv)*/
